...
namespace SettingsIni
{
	...
	// Main
	inline bool bHandleRightHand = true;
	inline bool bHandleLeftHand = true;

	inline bool bHandleWeapons = true;
	inline bool bHandleShields = true;
	inline bool bHandleSpells = true;

	inline bool bApplyOnTwoHanded = true;
	inline bool bApplyOnBow = true;
	...
	public:
		SettingsManager()
		{
			bindings = {
				...
				// Main
				{ "Main", "bHandleRightHand", &bHandleRightHand },
				{ "Main", "bHandleLeftHand", &bHandleLeftHand },

				{ "Main", "bHandleWeapons", &bHandleWeapons },
				{ "Main", "bHandleShields", &bHandleShields },
				{ "Main", "bHandleSpells", &bHandleSpells },

				{ "Main", "bApplyOnTwoHanded", &bApplyOnTwoHanded },
				{ "Main", "bApplyOnBow", &bApplyOnBow }
			};
		}
	...
	private:
		inline static std::string path = "Data/SKSE/Plugins/NoAutoEquipBehaviour.ini";
